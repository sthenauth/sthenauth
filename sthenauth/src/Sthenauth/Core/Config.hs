...
data Config = Config
  { -- | Path to the directory where secret data can be stored.
    ...
    -- | Allow maintenance tasks to be run in dedicated threads.  Like
    -- other options, only one instance of Sthenauth should run the
    -- maintenance tasks.
    _allowMaintenanceTasks :: Bool,
